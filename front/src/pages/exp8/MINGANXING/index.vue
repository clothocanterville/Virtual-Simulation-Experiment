<template>
    ...
    <p class="content">在本实验中，我们探究单因素的变化对于项目的可行性影响。在本实验中选择净现值为分析指标。净现值指未来资金（现金）流入（收入）现值与未来资金（现金）流出（支出）现值的差额，
      ...
      <p class="content">1.基准折现率ic。基准收益率也称为基准折现率，是企业或行业或投资者以动态的观点所确定的、可接受的投资方案最低标准的收益水平(0-1)。
    </p>
    <p class="content">2.售价price。
    </p>
    <p class="content">3.销售额sale。
    </p>
    <p class="content">4.成本cost
    </p>
    <p class="content">5.增长率r.当年净现金流量与上一年净现金流量的比值（>=1)
    </p>
    <p class="content">6.方案生命周期n
    </p>
...
<div>
    ...
    <div class="image-container">
        <img v-if="isImageVisible" src="@/assets/image/result.png" alt="Image" class="forimage" />
    </div>
    <br /><br />
</template>
...
    });
    ...
    submit() {
      ...
      this.jsonData.name_vars=["1","2","3","4","5","6"];
      this.jsonData.bound_vars=[[0,1],[230,240],[4000,5000],[150,155],[1,1.4],[1,4]];
